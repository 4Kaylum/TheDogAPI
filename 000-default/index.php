<?php
    ...
    $page = new Page(
        ...
        array(
            ...
            "This site uses cookies, mostly for Google analytics, but if you manage to have an account here, your login is stored in a cookie. Just thought you should know. It's an EU legal requirement. It's quite annoying, but whatever. By using the site you agree to allow me to store cookies on your browser etc.",
            ...
            "With that all said, there's not much more going on. Hit me up with any suggestions over at <a href='mailto:admin@callumb.co.uk'>my email</a> if you want to, and if you're at all interested, I have my own <a href='https://patreon.com/CallumBartlett'>Patreon page</a> if you wanna throw some spare cash at me. There's a one-time donation option if you want to set me up for a coffee or anything.",
